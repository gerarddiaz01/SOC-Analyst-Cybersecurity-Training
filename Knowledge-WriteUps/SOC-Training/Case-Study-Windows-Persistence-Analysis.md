...
## 1. Alert Scenario & Initial Triage
...
**Analyst Note:** As a System Engineer, Oliver Thompson is a "Power User." Attackers target these accounts because their administrative actions (like creating tasks) often blend in with legitimate IT operations.

---

## 2. Phase 1: Investigating the Scheduled Task
...
![Evidence of Task Triggers and Actions](image_dd0106.png)

---

## 3. Phase 2: Pulling the Thread (Forensic Pivot)
...
**Query (Sysmon Pivot):**
Standard Security logs (4688) often lack depth, so I pivoted to **Sysmon Event ID 1** for better visibility into the command line and hashes.
```splunk
...
![Sysmon Process Creation Details](6-1.png)
...
![Security Group Enumeration Evidence](11.png)
...
![Failed vs Successful Logon Timeline](10.png)
