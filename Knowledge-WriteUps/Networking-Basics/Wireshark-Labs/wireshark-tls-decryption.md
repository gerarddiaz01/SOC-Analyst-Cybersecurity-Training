...
*Figure 1 : Injection du fichier de clés SSL dans Wireshark.*
...
*Figure 2 : Localisation des paquets HTTP POST contenant le terme "login".*
...
*Figure 3 : Visualisation des données POST déchiffrées.*
